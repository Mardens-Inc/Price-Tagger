import {Autocomplete, AutocompleteItem, Button, Card, CardBody, CardFooter, CardHeader, cn, Image, Input, Switch, Tooltip} from "@nextui-org/react";
import {useEffect, useState} from "react";
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
import {faPrint} from "@fortawesome/free-solid-svg-icons";
import {departments} from "../pages/Home.tsx";
...
export default function GeneralForm()
{
    ...
    return (
        <Card classNames={{
            ...
            <CardHeader>
                <p className={"text-4xl"}> General Tags </p>
